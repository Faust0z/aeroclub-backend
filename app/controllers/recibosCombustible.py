    ...
    def crearRecibo(self, emailGestor, monto, observaciones, tipoPago, motivo):
        try:
            ...
            clienteTieneRol = (
                db.session.query(UsuarioTieneRoles)
                .filter_by(
                    usuarios_id=cliente.id_usuarios, roles_id=rolCliente.id_roles
                )
                .first()
            )
            ...
            # pago del cliente
            transaccionCliente = cuentaCorrienteController.actualizar_saldo(
            ...
            if transaccionCliente:
                ...
                tipoRecibo = (
                    ...
                    .filter_by(tipo="Recibo de Combustible")
                    .first()
                )
                ...
                recibo = Recibos(
                    ...
                    transaccionCliente.id_transacciones,
                    num_recibo,
                )
                ...
                if recibo:
                    ...
                    asociadoTieneRecibo = UsuariosTienenRecibos(
                        None, recibo.id_recibos, cliente.id_usuarios, "Asociado"
                    )
