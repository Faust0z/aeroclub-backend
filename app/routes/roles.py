    ...
    if has_access:
        try:
            ...
            if respuesta == 4:
                return jsonify(
                    {
                        "message": "El mail no es válido y no esta asociado a una cuenta",
                        "success": False,
                    }
                )
    ...
    if has_access:
        try:
            ...
            if respuesta == 3:
                return jsonify(
                    {
                        "mensaje": "El rol que quiere eliminar no lo posee, asi que no se realiza acciones",
                        "success": False,
                    }
                )
            if respuesta == 4:
    ...
    if has_access:
        try:
            ...
            if getUsuario:
                ...
                return jsonify({"message": "No se encontro un usuario con este email"})
